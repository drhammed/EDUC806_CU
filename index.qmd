...
The data for this tutorial is based on the study of Maglio and Polman (2014). This is an open-data and available on OSL open stats lab (thanks for the folks doing this). At the end of this tutorial, you should be able to reproduce the analysis and [Figure 1](https://journals.sagepub.com/stoken/default+domain/hv65WpzIjfXtVjXCbJw6/full) of this paper.
...
N.B.- For good-publication friendly- plots, I strong recommend using R/R-Studio. See the same plot in R- which clearly looks more like the one in the paper- including the CI)
